...
allDefined = function(req){
    ...
    if(typeof(req.assessment) === 'undefined'){
        return false;
    }
    return true;
}
...
module.exports = {
    upload: async function(req){
        ...
        //Tasks: (matches order displayed in app)
        //1: nameface
        //2: who's new
        //3: memory
        //4: shuffle
        ...
        pgClient.query("INSERT INTO assessmenttask (userid, level, race, score) VALUES ($1, $2, $3, $4)", [req.token, req.level, req.race, req.assessment])
        .catch(err => {
            return new Promise(function(resolve, reject){
                reject(err);
            })
