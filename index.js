        ...
        tokenHandler.verify(req.header('Authorization').split(' ')[1])
            .then(id => {
                try {
                    ...
                    var raceName = preCount.rows[0].race;//String(req.body.race.rows[0]); //.race.rows[0]['race']
        ...
        tokenHandler.verify(req.header('Authorization').split(' ')[1])
            .then(id => {
                try {
                    var images = [];
                    var faceNums = [];
                    var raceName = preCount.rows[0].race;//String(req.body.race.rows[0]);//String(req.body.days[0].race);
